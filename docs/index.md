...
- [Safe You Baas](https://github.com/UTE-SafeYou/safeyou-baas) - phát triển nền tảng Back-end as a Service cho Safe You
- [Safe You Client](https://github.com/UTE-SafeYou/safeyou-client) - phát triển nền tảng Front-end cho Safe You
- [Safe You Internals](https://github.com/UTE-SafeYou/safeyou-internals) - phát triển nền tảng quản trị và quản lý dữ liệu nội bộ cho Safe You
